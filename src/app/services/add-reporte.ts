...
export class ReporteService {
  private apiUrl = 'http://localhost:8888/web/up-tickets-back/add-reporte.php';
  ...
  getReportes(profesorId :string): Observable<any> {
    ...
    return this.http.get<any>('http://localhost:8888/web/up-tickets-back/get-reportes.php', { 
    headers,
